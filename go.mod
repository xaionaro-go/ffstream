...
require (
	...
	github.com/xaionaro-go/avpipeline v0.0.0-20250825181413-387143caf001
...
require github.com/xaionaro-go/sockopt v0.0.0-20250823181757-5c02c9cd7b51 // indirect
