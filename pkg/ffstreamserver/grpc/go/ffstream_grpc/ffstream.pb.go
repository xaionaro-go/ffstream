...
type AutoBitRateCalculator struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Calculator:
	//
	//	*AutoBitRateCalculator_Thresholds
	Calculator    isAutoBitRateCalculator_Calculator `protobuf_oneof:"calculator"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AutoBitRateCalculator) GetCalculator() isAutoBitRateCalculator_Calculator {
	if x != nil {
		return x.Calculator
	}
	return nil
...
func (x *AutoBitRateCalculator) GetThresholds() *avpipeline.AutoBitRateCalculatorThresholds {
	if x != nil {
		if x, ok := x.Calculator.(*AutoBitRateCalculator_Thresholds); ok {
			return x.Thresholds
		}
	}
	return nil
...
type isAutoBitRateCalculator_Calculator interface {
	isAutoBitRateCalculator_Calculator()
}

type AutoBitRateCalculator_Thresholds struct {
	Thresholds *avpipeline.AutoBitRateCalculatorThresholds `protobuf:"bytes,1,opt,name=thresholds,proto3,oneof"`
}

func (*AutoBitRateCalculator_Thresholds) isAutoBitRateCalculator_Calculator() {}

type GetAutoBitRateCalculatorRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetAutoBitRateCalculatorRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type GetAutoBitRateCalculatorReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Calculator    *AutoBitRateCalculator `protobuf:"bytes,1,opt,name=calculator,proto3" json:"calculator,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetAutoBitRateCalculatorReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetAutoBitRateCalculatorReply) GetCalculator() *AutoBitRateCalculator {
	if x != nil {
		return x.Calculator
	}
	return nil
...
type SetAutoBitRateCalculatorRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Calculator    *AutoBitRateCalculator `protobuf:"bytes,1,opt,name=calculator,proto3" json:"calculator,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *SetAutoBitRateCalculatorRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SetAutoBitRateCalculatorRequest) GetCalculator() *AutoBitRateCalculator {
	if x != nil {
		return x.Calculator
	}
	return nil
...
type SetAutoBitRateCalculatorReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SetAutoBitRateCalculatorReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type GetFPSDividerRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetFPSDividerRequest) Reset() {
	*x = GetFPSDividerRequest{}
	mi := &file_ffstream_proto_msgTypes[37]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetFPSDividerRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetFPSDividerRequest) ProtoMessage() {}

func (x *GetFPSDividerRequest) ProtoReflect() protoreflect.Message {
	mi := &file_ffstream_proto_msgTypes[37]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetFPSDividerRequest.ProtoReflect.Descriptor instead.
func (*GetFPSDividerRequest) Descriptor() ([]byte, []int) {
	return file_ffstream_proto_rawDescGZIP(), []int{37}
}

type GetFPSDividerReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetFPSDividerReply) Reset() {
	*x = GetFPSDividerReply{}
	mi := &file_ffstream_proto_msgTypes[38]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetFPSDividerReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetFPSDividerReply) ProtoMessage() {}

func (x *GetFPSDividerReply) ProtoReflect() protoreflect.Message {
	mi := &file_ffstream_proto_msgTypes[38]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetFPSDividerReply.ProtoReflect.Descriptor instead.
func (*GetFPSDividerReply) Descriptor() ([]byte, []int) {
	return file_ffstream_proto_rawDescGZIP(), []int{38}
}

func (x *GetFPSDividerReply) GetNum() uint32 {
	if x != nil {
		return x.Num
	}
	return 0
...
func (x *GetFPSDividerReply) GetDen() uint32 {
	if x != nil {
		return x.Den
	}
	return 0
...
type SetFPSDividerRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Num           uint32                 `protobuf:"varint,1,opt,name=num,proto3" json:"num,omitempty"`
	Den           uint32                 `protobuf:"varint,2,opt,name=den,proto3" json:"den,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *SetFPSDividerRequest) Reset() {
	*x = SetFPSDividerRequest{}
	mi := &file_ffstream_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetFPSDividerRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetFPSDividerRequest) ProtoMessage() {}

func (x *SetFPSDividerRequest) ProtoReflect() protoreflect.Message {
	mi := &file_ffstream_proto_msgTypes[39]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetFPSDividerRequest.ProtoReflect.Descriptor instead.
func (*SetFPSDividerRequest) Descriptor() ([]byte, []int) {
	return file_ffstream_proto_rawDescGZIP(), []int{39}
}

func (x *SetFPSDividerRequest) GetNum() uint32 {
	if x != nil {
		return x.Num
	}
	return 0
...
func (x *SetFPSDividerRequest) GetDen() uint32 {
	if x != nil {
		return x.Den
	}
	return 0
...
type SetFPSDividerReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SetFPSDividerReply) Reset() {
	*x = SetFPSDividerReply{}
	mi := &file_ffstream_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetFPSDividerReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetFPSDividerReply) ProtoMessage() {}

func (x *SetFPSDividerReply) ProtoReflect() protoreflect.Message {
	mi := &file_ffstream_proto_msgTypes[40]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetFPSDividerReply.ProtoReflect.Descriptor instead.
func (*SetFPSDividerReply) Descriptor() ([]byte, []int) {
...
var file_ffstream_proto_rawDesc = string([]byte{
	...
	0x64, 0x65, 0x6f, 0x22, 0x19, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x64, 0x65,
	0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x4d,
	0x0a, 0x15, 0x47, 0x65, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x34, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x66, 0x66, 0x73, 0x74, 0x72, 0x65,
	...
	0x17, 0x53, 0x65, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	...
	0x65, 0x61, 0x6d, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x65, 0x63, 0x6f, 0x64, 0x65, 0x72,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x17,
	0x0a, 0x15, 0x53, 0x65, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x29, 0x0a, 0x27, 0x47, 0x65, 0x74, 0x54, 0x6f,
	...
	0x73, 0x74, 0x22, 0x3d, 0x0a, 0x25, 0x47, 0x65, 0x74, 0x54, 0x6f, 0x6c, 0x65, 0x72, 0x61, 0x62,
	0x6c, 0x65, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x51, 0x75, 0x65, 0x75, 0x65, 0x53, 0x69, 0x7a,
	0x65, 0x42, 0x79, 0x74, 0x65, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x22, 0x3f, 0x0a, 0x27, 0x53, 0x65, 0x74, 0x54, 0x6f, 0x6c, 0x65, 0x72, 0x61, 0x62, 0x6c,
	...
	0x70, 0x75, 0x74, 0x49, 0x44, 0x22, 0xba, 0x19, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x4f, 0x75, 0x74,
	...
	,
	...
	0x65, 0x2e, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x05, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x22, 0x74, 0x0a,
	0x15, 0x41, 0x75, 0x74, 0x6f, 0x42, 0x69, 0x74, 0x52, 0x61, 0x74, 0x65, 0x43, 0x61, 0x6c, 0x63,
	0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x4d, 0x0a, 0x0a, 0x74, 0x68, 0x72, 0x65, 0x73, 0x68,
	0x6f, 0x6c, 0x64, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x61, 0x76, 0x70,
	...
	,
	...
	,
	...
	0x6d, 0x6f, 0x76, 0x65, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22,
	0x00, 0x12, 0x62, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x26, 0x2e, 0x66, 0x66, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d,
	...
	,
	...
	0x79, 0x22, 0x00, 0x12, 0x4a, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x73, 0x12,
	...
	,
	...
	0x00, 0x12, 0x59, 0x0a, 0x0d, 0x53, 0x65, 0x74, 0x53, 0x52, 0x54, 0x46, 0x6c, 0x61, 0x67, 0x49,
	...
	,
	...
	,
	...
	0x63, 0x2e, 0x53, 0x65, 0x74, 0x46, 0x50, 0x53, 0x44, 0x69, 0x76, 0x69, 0x64, 0x65, 0x72, 0x52,
...
var file_ffstream_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_ffstream_proto_goTypes = []any{
	...
	(*AutoBitRateCalculator)(nil),                             // 34: ffstream_grpc.AutoBitRateCalculator
	(*GetAutoBitRateCalculatorRequest)(nil),                   // 35: ffstream_grpc.GetAutoBitRateCalculatorRequest
	(*GetAutoBitRateCalculatorReply)(nil),                     // 36: ffstream_grpc.GetAutoBitRateCalculatorReply
	(*SetAutoBitRateCalculatorRequest)(nil),                   // 37: ffstream_grpc.SetAutoBitRateCalculatorRequest
	(*SetAutoBitRateCalculatorReply)(nil),                     // 38: ffstream_grpc.SetAutoBitRateCalculatorReply
	(*GetFPSDividerRequest)(nil),                              // 39: ffstream_grpc.GetFPSDividerRequest
	(*GetFPSDividerReply)(nil),                                // 40: ffstream_grpc.GetFPSDividerReply
	(*SetFPSDividerRequest)(nil),                              // 41: ffstream_grpc.SetFPSDividerRequest
	(*SetFPSDividerReply)(nil),                                // 42: ffstream_grpc.SetFPSDividerReply
	(*avpipeline.Node)(nil),                                   // 43: avpipeline.Node
	(*avpipeline.AutoBitRateCalculatorThresholds)(nil),        // 44: avpipeline.AutoBitRateCalculatorThresholds
}
var file_ffstream_proto_depIdxs = []int32{
	...
	43, // 15: ffstream_grpc.GetPipelinesResponse.nodes:type_name -> avpipeline.Node
	44, // 16: ffstream_grpc.AutoBitRateCalculator.thresholds:type_name -> avpipeline.AutoBitRateCalculatorThresholds
	34, // 17: ffstream_grpc.GetAutoBitRateCalculatorReply.calculator:type_name -> ffstream_grpc.AutoBitRateCalculator
	34, // 18: ffstream_grpc.SetAutoBitRateCalculatorRequest.calculator:type_name -> ffstream_grpc.AutoBitRateCalculator
	2,  // 19: ffstream_grpc.FFStream.SetLoggingLevel:input_type -> ffstream_grpc.SetLoggingLevelRequest
	5,  // 20: ffstream_grpc.FFStream.RemoveOutput:input_type -> ffstream_grpc.RemoveOutputRequest
	10, // 21: ffstream_grpc.FFStream.GetRecoderConfig:input_type -> ffstream_grpc.GetRecoderConfigRequest
	12, // 22: ffstream_grpc.FFStream.SetRecoderConfig:input_type -> ffstream_grpc.SetRecoderConfigRequest
	14, // 23: ffstream_grpc.FFStream.GetTolerableOutputQueueSizeBytes:input_type -> ffstream_grpc.GetTolerableOutputQueueSizeBytesRequest
	16, // 24: ffstream_grpc.FFStream.SetTolerableOutputQueueSizeBytes:input_type -> ffstream_grpc.SetTolerableOutputQueueSizeBytesRequest
	18, // 25: ffstream_grpc.FFStream.GetStats:input_type -> ffstream_grpc.GetStatsRequest
	22, // 26: ffstream_grpc.FFStream.GetOutputSRTStats:input_type -> ffstream_grpc.GetOutputSRTStatsRequest
	24, // 27: ffstream_grpc.FFStream.GetSRTFlagInt:input_type -> ffstream_grpc.GetSRTFlagIntRequest
	26, // 28: ffstream_grpc.FFStream.SetSRTFlagInt:input_type -> ffstream_grpc.SetSRTFlagIntRequest
	28, // 29: ffstream_grpc.FFStream.WaitChan:input_type -> ffstream_grpc.WaitRequest
	30, // 30: ffstream_grpc.FFStream.End:input_type -> ffstream_grpc.EndRequest
	32, // 31: ffstream_grpc.FFStream.GetPipelines:input_type -> ffstream_grpc.GetPipelinesRequest
	35, // 32: ffstream_grpc.FFStream.GetAutoBitRateCalculator:input_type -> ffstream_grpc.GetAutoBitRateCalculatorRequest
	37, // 33: ffstream_grpc.FFStream.SetAutoBitRateCalculator:input_type -> ffstream_grpc.SetAutoBitRateCalculatorRequest
	39, // 34: ffstream_grpc.FFStream.GetFPSDivider:input_type -> ffstream_grpc.GetFPSDividerRequest
	41, // 35: ffstream_grpc.FFStream.SetFPSDivider:input_type -> ffstream_grpc.SetFPSDividerRequest
	3,  // 36: ffstream_grpc.FFStream.SetLoggingLevel:output_type -> ffstream_grpc.SetLoggingLevelReply
	6,  // 37: ffstream_grpc.FFStream.RemoveOutput:output_type -> ffstream_grpc.RemoveOutputReply
	11, // 38: ffstream_grpc.FFStream.GetRecoderConfig:output_type -> ffstream_grpc.GetRecoderConfigReply
	13, // 39: ffstream_grpc.FFStream.SetRecoderConfig:output_type -> ffstream_grpc.SetRecoderConfigReply
	15, // 40: ffstream_grpc.FFStream.GetTolerableOutputQueueSizeBytes:output_type -> ffstream_grpc.GetTolerableOutputQueueSizeBytesReply
	17, // 41: ffstream_grpc.FFStream.SetTolerableOutputQueueSizeBytes:output_type -> ffstream_grpc.SetTolerableOutputQueueSizeBytesReply
	19, // 42: ffstream_grpc.FFStream.GetStats:output_type -> ffstream_grpc.GetStatsReply
	23, // 43: ffstream_grpc.FFStream.GetOutputSRTStats:output_type -> ffstream_grpc.GetOutputSRTStatsReply
	25, // 44: ffstream_grpc.FFStream.GetSRTFlagInt:output_type -> ffstream_grpc.GetSRTFlagIntReply
	27, // 45: ffstream_grpc.FFStream.SetSRTFlagInt:output_type -> ffstream_grpc.SetSRTFlagIntReply
	29, // 46: ffstream_grpc.FFStream.WaitChan:output_type -> ffstream_grpc.WaitReply
	31, // 47: ffstream_grpc.FFStream.End:output_type -> ffstream_grpc.EndReply
	33, // 48: ffstream_grpc.FFStream.GetPipelines:output_type -> ffstream_grpc.GetPipelinesResponse
	36, // 49: ffstream_grpc.FFStream.GetAutoBitRateCalculator:output_type -> ffstream_grpc.GetAutoBitRateCalculatorReply
	38, // 50: ffstream_grpc.FFStream.SetAutoBitRateCalculator:output_type -> ffstream_grpc.SetAutoBitRateCalculatorReply
	40, // 51: ffstream_grpc.FFStream.GetFPSDivider:output_type -> ffstream_grpc.GetFPSDividerReply
	42, // 52: ffstream_grpc.FFStream.SetFPSDivider:output_type -> ffstream_grpc.SetFPSDividerReply
...
func file_ffstream_proto_init() {
	...
	file_ffstream_proto_msgTypes[32].OneofWrappers = []any{
