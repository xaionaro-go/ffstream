...
type TrackLatencies struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	PreEncodingU    uint64                 `protobuf:"varint,1,opt,name=preEncodingU,proto3" json:"preEncodingU,omitempty"`
...
func (x *TrackLatencies) GetPreEncodingU() uint64 {
	if x != nil {
		return x.PreEncodingU
	}
	return 0
}
...
var file_ffstream_proto_rawDesc = string([]byte{
	...
	0x65, 0x6e, 0x63, 0x69, 0x65, 0x73, 0x12, 0x22, 0x0a, 0x0c, 0x70, 0x72, 0x65, 0x45, 0x6e, 0x63,
	0x6f, 0x64, 0x69, 0x6e, 0x67, 0x55, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0c, 0x70, 0x72,
	0x65, 0x45, 0x6e, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x55, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65,
