...
type FFStreamClient interface {
	...
	WaitChan(ctx context.Context, in *WaitRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WaitReply], error)
...
func (c *fFStreamClient) WaitChan(ctx context.Context, in *WaitRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WaitReply], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &FFStream_ServiceDesc.Streams[0], FFStream_WaitChan_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[WaitRequest, WaitReply]{ClientStream: stream}
...
type FFStream_WaitChanClient = grpc.ServerStreamingClient[WaitReply]
...
func (c *fFStreamClient) Monitor(ctx context.Context, in *avpipeline.MonitorRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[avpipeline.MonitorEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type FFStream_MonitorClient = grpc.ServerStreamingClient[avpipeline.MonitorEvent]
...
func (c *fFStreamClient) InjectSubtitles(ctx context.Context, in *InjectSubtitlesRequest, opts ...grpc.CallOption) (*InjectSubtitlesReply, error) {
	...
	err := c.cc.Invoke(ctx, FFStream_InjectSubtitles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fFStreamClient) InjectData(ctx context.Context, in *InjectDataRequest, opts ...grpc.CallOption) (*InjectDataReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InjectDataReply)
	err := c.cc.Invoke(ctx, FFStream_InjectData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FFStreamServer interface {
	...
	WaitChan(*WaitRequest, grpc.ServerStreamingServer[WaitReply]) error
...
// UnimplementedFFStreamServer must be embedded to have
...
func (UnimplementedFFStreamServer) WaitChan(*WaitRequest, grpc.ServerStreamingServer[WaitReply]) error {
	return status.Error(codes.Unimplemented, "method WaitChan not implemented")
}
...
func (UnimplementedFFStreamServer) Monitor(*avpipeline.MonitorRequest, grpc.ServerStreamingServer[avpipeline.MonitorEvent]) error {
...
func RegisterFFStreamServer(s grpc.ServiceRegistrar, srv FFStreamServer) {
	// If the following call panics, it indicates UnimplementedFFStreamServer was
...
func _FFStream_WaitChan_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(FFStreamServer).WaitChan(m, &grpc.GenericServerStream[WaitRequest, WaitReply]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type FFStream_WaitChanServer = grpc.ServerStreamingServer[WaitReply]
...
func _FFStream_Monitor_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(FFStreamServer).Monitor(m, &grpc.GenericServerStream[avpipeline.MonitorRequest, avpipeline.MonitorEvent]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type FFStream_MonitorServer = grpc.ServerStreamingServer[avpipeline.MonitorEvent]
...
func _FFStream_InjectSubtitles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(FFStreamServer).InjectSubtitles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FFStream_InjectSubtitles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FFStreamServer).InjectSubtitles(ctx, req.(*InjectSubtitlesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _FFStream_InjectData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InjectDataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FFStreamServer).InjectData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FFStream_InjectData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FFStreamServer).InjectData(ctx, req.(*InjectDataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
