...
// hot-add gap (daemon log never reached AAudio open). The
// "actually-routes" question is resolvable purely by checking
// URL→DeviceID routing — the path this CLI-based test exercises.
//
...
// TestMicRoutingActuallyRoutes verifies that selecting a non-default
// microphone routes the daemon's audio capture to the requested mic.
//
// Hardware constraint: the test is hardware-bound to the Pixel 8a phone
// at serial 41041JEKB08092 because (a) it has multiple physical
